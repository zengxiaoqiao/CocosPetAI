    ...
    execute: function () {
      ...
      _export("CompanionDaysDisplay", CompanionDaysDisplay = (_dec = ccclass('CompanionDaysDisplay'), _dec2 = property({
        ...
        _refreshFromStorage(recordVisit) {
          var state = recordVisit ? (_crd && recordCompanionVisitToday === void 0 ? (_reportPossibleCrUseOfrecordCompanionVisitToday({
            error: Error()
        ...
        refreshDisplay() {
          var state = (_crd && getCompanionDaysState === void 0 ? (_reportPossibleCrUseOfgetCompanionDaysState({
            error: Error()
          }), getCompanionDaysState) : getCompanionDaysState)();
          this._totalDays = state.totalDays;
          this._streakDays = state.streakDays;
