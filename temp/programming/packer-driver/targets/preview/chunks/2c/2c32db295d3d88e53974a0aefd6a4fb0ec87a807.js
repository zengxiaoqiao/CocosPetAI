System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, director, sys, SharedBtnCounts, STORAGE_UNLOCK_INTENT, STORAGE_RECHARGE_RETURN_SCENE, unlockCat, markSelectCatAfterUnlock, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, RechargePanel;
  ...
  function _reportPossibleCrUseOfSTORAGE_UNLOCK_INTENT(extras) {
    _reporterNs.report("STORAGE_UNLOCK_INTENT", "./PetUnlock", _context.meta, extras);
  }

  function _reportPossibleCrUseOfSTORAGE_RECHARGE_RETURN_SCENE(extras) {
    _reporterNs.report("STORAGE_RECHARGE_RETURN_SCENE", "./PetUnlock", _context.meta, extras);
  }
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      STORAGE_UNLOCK_INTENT = _unresolved_3.STORAGE_UNLOCK_INTENT;
      STORAGE_RECHARGE_RETURN_SCENE = _unresolved_3.STORAGE_RECHARGE_RETURN_SCENE;
      unlockCat = _unresolved_3.unlockCat;
      markSelectCatAfterUnlock = _unresolved_3.markSelectCatAfterUnlock;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("RechargePanel", RechargePanel = (_dec = ccclass('RechargePanel'), _dec2 = property(Node), _dec3 = property({
        ...
        onCloseButtonClick() {
          ...
          var unlockIntent = sys.localStorage.getItem(_crd && STORAGE_UNLOCK_INTENT === void 0 ? (_reportPossibleCrUseOfSTORAGE_UNLOCK_INTENT({
            error: Error()
          }), STORAGE_UNLOCK_INTENT) : STORAGE_UNLOCK_INTENT);
          ...
          if (unlockIntent === 'cat') {
            ...
            try {
              sys.localStorage.removeItem(_crd && STORAGE_UNLOCK_INTENT === void 0 ? (_reportPossibleCrUseOfSTORAGE_UNLOCK_INTENT({
                error: Error()
              }), STORAGE_UNLOCK_INTENT) : STORAGE_UNLOCK_INTENT);
          ...
          var pet = sys.localStorage.getItem('recharge_pet');
          var btnStr = sys.localStorage.getItem('recharge_button');

          if (pet && btnStr) {
            var btn = parseInt(btnStr);

            if (btn === 1 || btn === 2 || btn === 3) {
              var key = "ad_reward_" + pet + "_btn" + btn;
              var old = parseInt(sys.localStorage.getItem(key) || '0');
        ...
        _closeAndReturnHome() {
          var scene = sys.localStorage.getItem(_crd && STORAGE_RECHARGE_RETURN_SCENE === void 0 ? (_reportPossibleCrUseOfSTORAGE_RECHARGE_RETURN_SCENE({
            error: Error()
          }), STORAGE_RECHARGE_RETURN_SCENE) : STORAGE_RECHARGE_RETURN_SCENE) || 'home';

          try {
            sys.localStorage.removeItem('recharge_pet');
            sys.localStorage.removeItem('recharge_button');
            sys.localStorage.removeItem(_crd && STORAGE_RECHARGE_RETURN_SCENE === void 0 ? (_reportPossibleCrUseOfSTORAGE_RECHARGE_RETURN_SCENE({
              error: Error()
            }), STORAGE_RECHARGE_RETURN_SCENE) : STORAGE_RECHARGE_RETURN_SCENE);
          } catch (_unused2) {
            /* ignore */
          }
...
//# sourceMappingURL=2c32db295d3d88e53974a0aefd6a4fb0ec87a807.js.map