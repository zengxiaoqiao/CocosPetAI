      ...
      _export("CarePanel", CarePanel = (_dec = ccclass('CarePanel'), _dec2 = property({
        ...
        onLoad() {
          ...
          if (!this.closeButton) {
            ...
            var close = (_this$node$getChildBy = this.node.getChildByName('close')) != null ? _this$node$getChildBy : this.node.getChildByName('Close');
        ...
        open() {
          ...
          var hasClaim = (_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
          ...
          if (this.checkInNode) {
            ...
            if (hasClaim) {
              var checkIn = this.checkInNode.getComponent(_crd && CheckInPanel === void 0 ? (_reportPossibleCrUseOfCheckInPanel({
                error: Error()
        ...
        _ensureBlockInput() {
          ...
          var target = ((_this$popupMask5 = this.popupMask) == null ? void 0 : _this$popupMask5.maskNode) || ((_this$popupMask6 = this.popupMask) == null ? void 0 : _this$popupMask6.node);
