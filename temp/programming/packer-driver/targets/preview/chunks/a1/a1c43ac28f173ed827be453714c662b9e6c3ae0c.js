System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Animation, director, find, PetValue, IS_FIRST_SESSION, PetInfoBar, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, RandomPlayPetAni;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("RandomPlayPetAni", RandomPlayPetAni = (_dec = ccclass('RandomPlayPetAni'), _dec2 = property(Animation), _dec3 = property(_crd && PetValue === void 0 ? (_reportPossibleCrUseOfPetValue({
        ...
        get clip01() {
          return this.prefix + "01";
        }

        get clip03() {
          return this.prefix + "03";
        }
        ...
        isSleeping() {
          ...
          var state = this.aniComponent.getState(this.clip03);
          if (state != null && state.isPlaying) return true;
        ...
        playRandomAni() {
          ...
          (_instance = (_crd && PetInfoBar === void 0 ? (_reportPossibleCrUseOfPetInfoBar({
            error: Error()
          }), PetInfoBar) : PetInfoBar).instance) == null || _instance.refreshSleepBubble(targetAniName === this.clip03);
...
//# sourceMappingURL=a1c43ac28f173ed827be453714c662b9e6c3ae0c.js.map