System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function readInt(key, fallback) {
    ...
    var n = parseInt(sys.localStorage.getItem(key) || '', 10);
  ...
  function recordCompanionVisitToday() {
    ...
    var last = sys.localStorage.getItem(STORAGE_KEY_LAST_COUNTED) || '';
    var total = readInt(STORAGE_KEY_TOTAL, 0);
    var streak = readInt(STORAGE_KEY_STREAK, 0);
  ...
  function getCompanionDaysDisplayText(state) {
    var s = state != null ? state : getCompanionDaysState();
