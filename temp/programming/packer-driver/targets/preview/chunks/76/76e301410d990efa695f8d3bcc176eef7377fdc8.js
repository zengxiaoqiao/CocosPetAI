    ...
    execute: function () {
      ...
      _export("PetValue", PetValue = (_dec = ccclass('PetValue'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(ProgressBar), _dec5 = property(ProgressBar), _dec6 = property(Node), _dec(_class = (_class2 = (_class3 = class PetValue extends Component {
        ...
        onLoad() {
          ...
          var savedMood = (_sys$localStorage$get = sys.localStorage.getItem(STORAGE_KEY_MOOD)) != null ? _sys$localStorage$get : sys.localStorage.getItem(STORAGE_KEY_INTIMACY_LEGACY);
        ...
        _hideHpUi() {
          ...
          var petHp = this.node.getChildByName('pet_hp');
        ...
        _playMoodHeartsIfHappy() {
          ...
          var hi = find('Canvas/highintimate');
          var heartComp = hi == null ? void 0 : hi.getComponent('HeartBubbleAni');
        ...
        _ensureLabels() {
          ...
          if (!this.intimacyLabel) {
            ...
            if (!this.intimacyLabel) {
              var friendship = this.node.getChildByName('pet_friendship');
        ...
        _spawnMoodFloatUp(delta, petNode, offsetX, onArrive) {
          if (offsetX === void 0) {
            offsetX = 0;
          }

          var target = this.intimacyLabel;
          ...
          var deltaNode = new Node('MoodDeltaFloat');
          ...
          if (petNode) {
            ...
            if (petUIT) {
              ...
              var petStartLocal = new Vec3(0, petH / 2 - 60, 0);
          ...
          var startX = startLocalPos.x + offsetX;
          var startY = startLocalPos.y;
          var startZ = startLocalPos.z;
          var riseY = 88;
          var floatDuration = 0.48;
        ...
        applyVoiceChat(petNode) {
          ...
          var addMood = VOICE_CHAT_MOOD_GAIN;
          this._mood = Math.min(MAX_VALUE, this._mood + addMood);
