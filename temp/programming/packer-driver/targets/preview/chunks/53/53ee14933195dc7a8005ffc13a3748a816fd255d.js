    ...
    execute: function () {
      ...
      _export("CustomizeScene", CustomizeScene = (_dec = ccclass('CustomizeScene'), _dec(_class = class CustomizeScene extends Component {
        ...
        _buildUi() {
          ...
          var root = canvas.getChildByName('customize_root');
          ...
          var bg = new Node('bg');
          root.addChild(bg);
          var bgUIT = bg.addComponent(UITransform);
          bgUIT.setContentSize(visible.width, visible.height);
          var bgW = bg.addComponent(Widget);
          ...
          root.addChild(title);
          var titleUIT = title.addComponent(UITransform);
          titleUIT.setContentSize(visible.width - 80, 120);
          title.setPosition(0, 80, 0);
          var titleLabel = title.addComponent(Label);
          ...
          var sub = new Node('subtitle');
          root.addChild(sub);
          var subUIT = sub.addComponent(UITransform);
          subUIT.setContentSize(visible.width - 100, 80);
          sub.setPosition(0, 10, 0);
          var subLabel = sub.addComponent(Label);
          ...
          var back = new Node('btn_back');
          root.addChild(back);
          var backUIT = back.addComponent(UITransform);
          ...
          var backLabelUIT = backLabelNode.addComponent(UITransform);
