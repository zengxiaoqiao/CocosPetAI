    ...
    execute: function () {
      ...
      _export("AIChatDemo", AIChatDemo = (_dec = ccclass('AIChatDemo'), _dec2 = property(EditBox), _dec3 = property(Label), _dec4 = property(Button), _dec5 = property({
        ...
        _applyChatRewards() {
          ...
          var petNode = isCat ? (_find = find('Canvas')) == null || (_find = _find.getComponentInChildren(_crd && CatController === void 0 ? (_reportPossibleCrUseOfCatController({
            error: Error()
        ...
        _runAutoTest() {
          ...
          return _asyncToGenerator(function* () {
            var label = _this.aiReplyLabel;
            var msg = (_this.autoTestMessage || '').trim() || '你好';
            ...
            try {
              ...
              var reply = yield (_crd && TokitChatService === void 0 ? (_reportPossibleCrUseOfTokitChatService({
                error: Error()
        ...
        sendMessage() {
          ...
          return _asyncToGenerator(function* () {
            ...
            var input = _this2.userInput;
            var label = _this2.aiReplyLabel;
            var msg = (_input$string$trim = input == null || (_input$string = input.string) == null ? void 0 : _input$string.trim()) != null ? _input$string$trim : '';
            ...
            if (_this2.sendBtn) _this2.sendBtn.interactable = false;
            if (label) label.string = '…';
            ...
            try {
              ...
              if (_this2.sendBtn) _this2.sendBtn.interactable = true;
            }
          })();
        }
        /**
