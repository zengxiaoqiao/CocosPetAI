System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "e93706ISOhHSK4Sfg7v4Dnl", "DogController", undefined);
      ...
      _export("DogController", DogController = (_dec = ccclass('DogController'), _dec2 = property(Animation), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(_crd && PetValue === void 0 ? (_reportPossibleCrUseOfPetValue({
        error: Error()
      }), PetValue) : PetValue), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec(_class = (_class2 = class DogController extends (_crd && PetControllerBase === void 0 ? (_reportPossibleCrUseOfPetControllerBase({
        error: Error()
...
//# sourceMappingURL=c381a07de802d02649b0d360a4aef8d21bf71bea.js.map