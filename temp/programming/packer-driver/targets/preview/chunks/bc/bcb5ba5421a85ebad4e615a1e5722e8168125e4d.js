System.register(["cc"], function (_export, _context) {
    ...
    if (sys.platform === sys.Platform.ANDROID && sys.isNative && typeof native !== 'undefined') {
      try {
        ...
        if ((_native = native) != null && (_native = _native.reflection) != null && _native.callStaticMethod) {
          if (date === undefined) {
            var ret = native.reflection.callStaticMethod('com/cocos/game/AppActivity', 'getLocalDateString', '()Ljava/lang/String;');
            if (typeof ret === 'string' && /^\d{4}-\d{2}-\d{2}$/.test(ret)) return ret;
          } else {
            var _ret = native.reflection.callStaticMethod('com/cocos/game/AppActivity', 'getLocalDateStringForTimestamp', '(J)Ljava/lang/String;', date.getTime());

            if (typeof _ret === 'string' && /^\d{4}-\d{2}-\d{2}$/.test(_ret)) return _ret;
          }
        }
      } catch (e) {
    ...
    if (sys.platform === sys.Platform.ANDROID && sys.isNative && typeof native !== 'undefined') {
      try {
        ...
        if ((_native2 = native) != null && (_native2 = _native2.reflection) != null && _native2.callStaticMethod) {
          var now = Date.now();
          var yesterdayMs = now - 86400000;
          var ret = native.reflection.callStaticMethod('com/cocos/game/AppActivity', 'getLocalDateStringForTimestamp', '(J)Ljava/lang/String;', yesterdayMs);
          if (typeof ret === 'string' && /^\d{4}-\d{2}-\d{2}$/.test(ret)) return ret;
        }
      } catch (e) {
  ...
  function getMsUntilNextLocalMidnight() {
    if (sys.platform === sys.Platform.ANDROID && sys.isNative && typeof native !== 'undefined') {
      try {
        ...
        if ((_native3 = native) != null && (_native3 = _native3.reflection) != null && _native3.callStaticMethod) {
          var ret = native.reflection.callStaticMethod('com/cocos/game/AppActivity', 'getMsUntilNextLocalMidnight', '()J');
    ...
    var msIntoDay = (h * 3600 + m * 60 + s) * 1000 + ms;
...
//# sourceMappingURL=bcb5ba5421a85ebad4e615a1e5722e8168125e4d.js.map