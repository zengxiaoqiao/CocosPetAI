  ...
  return {
    ...
    execute: function () {
      ...
      _export("AdButton", AdButton = (_dec = ccclass('AdButton'), _dec2 = property({
        ...
        _hookCountsRefresh() {
          const prev = (_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
        ...
        _refreshTotalLabel() {
          ...
          const total = (_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
        ...
        _bindItemButtons() {
          ...
          const toggle = (_ref = (_find$getComponent = (_find = find('Canvas/TogglePet')) == null ? void 0 : _find.getComponent(_crd && TogglePet === void 0 ? (_reportPossibleCrUseOfTogglePet({
            error: Error()
          ...
          const bind = (path, handler) => {
            const n = find(path);
            if (!n) return;
            const b = n.getComponent(Button) || n.addComponent(Button); // 场景里 Button 的 clickEvents（狗/猫 onBtn1Click）无法被 node.off 移除，会连点两次：先扣次数再进广告
        ...
        _playMicHide() {
          ...
          const shrunk = new Vec3(this._micBaseScale.x * 0.88, this._micBaseScale.y * 0.88, 1);
        ...
        _playItemsHide() {
          ...
          const endScale = new Vec3(this._itemsBaseScale.x * 0.88, this._itemsBaseScale.y * 0.88, 1);
          tween(this.itemsRoot).to(dur, {
