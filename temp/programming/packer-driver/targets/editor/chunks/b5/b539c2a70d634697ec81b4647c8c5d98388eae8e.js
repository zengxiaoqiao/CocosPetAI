System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function applySettingsSceneLocale() {
    ...
    const verLabel = verNode == null ? void 0 : verNode.getComponent(Label);

    if (verLabel) {
      const v = (_crd && getNativeAppVersionName === void 0 ? (_reportPossibleCrUseOfgetNativeAppVersionName({
        error: Error()
    ...
    const setRow = (rowName, text) => {
      const row = canvas.getChildByName(rowName);
      if (!row) return;
      const labNode = row.getChildByName('Label');
      const lab = labNode == null ? void 0 : labNode.getComponent(Label);
...
//# sourceMappingURL=b539c2a70d634697ec81b4647c8c5d98388eae8e.js.map