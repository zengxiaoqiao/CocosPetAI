System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Animation, Node, Vec2, director, sys, Label, find, Button, RandomPlayPetAni, PetValue, SharedBtnCounts, PetInfoBar, HeartBubbleAni, SwipeState, _dec, _class, _class2, _crd, ccclass, CLIP_SUFFIXES, SHORT_SUFFIX, LONG_SUFFIX, PetControllerBase;
  ...
  return {
    setters: [function (_unresolved_) {
      ...
      SharedBtnCounts = _unresolved_4.SharedBtnCounts;
    }, function (_unresolved_5) {
      PetInfoBar = _unresolved_5.PetInfoBar;
    }, function (_unresolved_6) {
      HeartBubbleAni = _unresolved_6.HeartBubbleAni;
    }, function (_unresolved_7) {
      SwipeState = _unresolved_7.SwipeState;
    }],
    execute: function () {
      _crd = true;
      ...
      _export("PetControllerBase", PetControllerBase = (_dec = ccclass('PetControllerBase'), _dec(_class = (_class2 = class PetControllerBase extends Component {
        ...
        onEnable() {
          ...
          const returnedFromAd = (_crd && RandomPlayPetAni === void 0 ? (_reportPossibleCrUseOfRandomPlayPetAni({
            error: Error()
        ...
        _onPetTouchStart(e) {
          var _this$_getMicroRecord;

          if (!this.node.active || this.isPlayingSequence) return;
          e.getUILocation(this._petTouchStart);
          this._petTouchMovedTooFar = false;
          (_this$_getMicroRecord = this._getMicroRecord()) == null || _this$_getMicroRecord.onPetTouchStart();
        }
        ...
        _onPetTouchMove(e) {
          ...
          if (dx * dx + dy * dy > PetControllerBase.PET_TOUCH_MOVE_CANCEL_PX * PetControllerBase.PET_TOUCH_MOVE_CANCEL_PX) {
            var _this$_getMicroRecord2;

            this._petTouchMovedTooFar = true;
            (_this$_getMicroRecord2 = this._getMicroRecord()) == null || _this$_getMicroRecord2.onPetTouchCancel();
          }
        }
        ...
        _onPetTouchEnd() {
          ...
          if (micro != null && micro.consumePetShortTap()) {
            this.onBtn0Click();
            return;
          }

          micro == null || micro.onPetTouchEnd();
        }

        _getMicroRecord() {
          const n = find('Canvas/btn_micro');
          return n == null ? void 0 : n.getComponent('BtnMicroRecord');
        }
        ...
        _setHeartBubbleAniEnabled(enabled) {
          const comp = this.node.getComponent(_crd && HeartBubbleAni === void 0 ? (_reportPossibleCrUseOfHeartBubbleAni({
            error: Error()
        ...
        _playNextFromQueue() {
          ...
          let durationMs = 3300; // 单独为 13 调整为动画实际时长（约 1.67s）
        ...
        _hideInfoBarTemporarily(seconds = 2) {
          ...
          this.scheduleOnce(() => {
            ...
            (_instance = (_crd && PetInfoBar === void 0 ? (_reportPossibleCrUseOfPetInfoBar({
              error: Error()
            }), PetInfoBar) : PetInfoBar).instance) == null || _instance.syncPassiveBubble();
          }, seconds);
        }

        _updateCountLabels() {
          const counts = [(_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
        ...
        _ensureBtnInteractableWhenZero() {
          const btns = [find('Canvas/btn/Button1'), find('Canvas/btn/Button2'), find('Canvas/btn/Button3')];
          const counts = [(_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
          }), SharedBtnCounts) : SharedBtnCounts).btn1, (_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
        ...
        _ensurePetValue() {
          ...
          const comp = n ? n.getComponent(_crd && PetValue === void 0 ? (_reportPossibleCrUseOfPetValue({
            error: Error()
          }), PetValue) : PetValue) : null;
        ...
        onBtn0Click() {
          ...
          if (s === '03') {
            ...
            (_instance2 = (_crd && PetInfoBar === void 0 ? (_reportPossibleCrUseOfPetInfoBar({
              error: Error()
            }), PetInfoBar) : PetInfoBar).instance) == null || _instance2.refreshSleepBubble(false);
          }
        ...
        onBtn1Click() {
          ...
          this._updateCountLabels(); // 数值：Button1 体力 +20、亲密 +5（具体数值变更逻辑交给 PetValue，内部已处理上限 100）
          ...
          const s = cur.slice(this.prefix.length);
          let seq = [];
          if (s === '14') seq = [this.clip('07'), this.clip('09'), this.clip('01')];else if (s === '03') seq = [this.clip('08'), this.clip('09'), this.clip('01')];else seq = [this.clip('09'), this.clip('01')];
          this.playSequence(seq);
        }
        ...
        onBtn2Click() {
          ...
          this._updateCountLabels(); // 数值：Button2 亲密 +20（具体数值变更逻辑交给 PetValue，内部已处理上限 100）
          ...
          const s = cur.slice(this.prefix.length);
          let seq = [];
          if (s === '14') seq = [this.clip('07'), this.clip('10'), this.clip('01')];else if (s === '03') seq = [this.clip('08'), this.clip('10'), this.clip('01')];else seq = [this.clip('10'), this.clip('01')];
          this.playSequence(seq);
        }
        ...
        onBtn3Click() {
          ...
          this._updateCountLabels(); // 数值：Button3 亲密 +20（具体数值变更逻辑交给 PetValue，内部已处理上限 100）
          ...
          const s = cur.slice(this.prefix.length);
          let seq = [];
          if (s === '14') seq = [this.clip('07'), this.clip('11'), this.clip('01')];else if (s === '03') seq = [this.clip('08'), this.clip('11'), this.clip('01')];else seq = [this.clip('11'), this.clip('01')];
          this.playSequence(seq);
        }
        ...
        wakeUpFromSleep() {
          ...
          if (s === '03') {
            ...
            (_instance3 = (_crd && PetInfoBar === void 0 ? (_reportPossibleCrUseOfPetInfoBar({
              error: Error()
            }), PetInfoBar) : PetInfoBar).instance) == null || _instance3.refreshSleepBubble(false); // Sleep -> wake: 08 (sit up) then 04 (look around)
        ...
        wakeToTalking() {
          ...
          if (s === '03') {
            ...
            (_instance4 = (_crd && PetInfoBar === void 0 ? (_reportPossibleCrUseOfPetInfoBar({
              error: Error()
            }), PetInfoBar) : PetInfoBar).instance) == null || _instance4.refreshSleepBubble(false); // Sleep -> wake (08->04) -> respond (15)
      ...
      }, _class2.PET_TOUCH_MOVE_CANCEL_PX = 28, _class2)) || _class));
...
//# sourceMappingURL=396794c26b9287d600fc800d773f2b61e37c1787.js.map