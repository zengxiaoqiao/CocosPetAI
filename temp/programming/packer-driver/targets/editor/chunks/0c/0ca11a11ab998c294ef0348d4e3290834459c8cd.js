  ...
  return {
    ...
    execute: function () {
      ...
      _export("AudioControl", AudioControl = (_dec = ccclass('AudioControl'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class AudioControl extends Component {
        ...
        onStopAllSounds() {
          const am = (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
        ...
        _syncAudioButtonVisibility() {
          const muted = (_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
            error: Error()
        ...
        getAudioManagerFromScene() {
          ...
          if (scene) {
            const am = scene.getComponentInChildren(_crd && AudioManager === void 0 ? (_reportPossibleCrUseOfAudioManager({
              error: Error()
...
//# sourceMappingURL=0ca11a11ab998c294ef0348d4e3290834459c8cd.js.map