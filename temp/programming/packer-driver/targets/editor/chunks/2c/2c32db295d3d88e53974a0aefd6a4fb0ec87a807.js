    ...
    execute: function () {
      ...
      _export("RechargePanel", RechargePanel = (_dec = ccclass('RechargePanel'), _dec2 = property(Node), _dec3 = property({
        ...
        onCloseButtonClick() {
          ...
          const unlockIntent = sys.localStorage.getItem(_crd && STORAGE_UNLOCK_INTENT === void 0 ? (_reportPossibleCrUseOfSTORAGE_UNLOCK_INTENT({
            error: Error()
        ...
        _closeAndReturnHome() {
          const scene = sys.localStorage.getItem(_crd && STORAGE_RECHARGE_RETURN_SCENE === void 0 ? (_reportPossibleCrUseOfSTORAGE_RECHARGE_RETURN_SCENE({
            error: Error()
