    ...
    execute: function () {
      ...
      _export("BtnAdGuard", BtnAdGuard = (_dec = _decorator.ccclass('BtnAdGuard'), _dec(_class = class BtnAdGuard extends Component {
        ...
        _tryGotoAd(buttonIndex) {
          const count = buttonIndex === 1 ? (_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
          ...
          try {
            ...
            const pet = (_this$_dogNode = this._dogNode) != null && _this$_dogNode.active ? 'dog' : (_this$_catNode = this._catNode) != null && _this$_catNode.active ? 'cat' : 'dog';
...
//# sourceMappingURL=00d8935fc5c0a099d36907979b6d7e80bf3bb25f.js.map