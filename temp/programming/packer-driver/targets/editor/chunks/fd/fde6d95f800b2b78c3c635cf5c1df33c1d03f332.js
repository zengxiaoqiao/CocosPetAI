      ...
      _export("CheckInPanel", CheckInPanel = (_dec = ccclass('CheckInPanel'), _dec2 = property(Button), _dec3 = property({
        ...
        constructor(...args) {
          ...
          this._refreshVisibility = () => {
            const show = (_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
              error: Error()
        ...
        _updateRewardVisibility() {
          ...
          const kind = (_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
          }), SharedBtnCounts) : SharedBtnCounts).getPendingRewardType();
          const container = this.node.getChildByName('Node');
          if (!container) return;
          const slot0 = (_container$getChildBy = container.getChildByName('Node1')) != null ? _container$getChildBy : container.children[0];
          const slot1 = (_container$getChildBy2 = container.getChildByName('Node2')) != null ? _container$getChildBy2 : container.children[1];
          const slot2 = (_container$getChildBy3 = container.getChildByName('Node3')) != null ? _container$getChildBy3 : container.children[2];
        ...
        onOKClick() {
          ...
          const granted = (_crd && SharedBtnCounts === void 0 ? (_reportPossibleCrUseOfSharedBtnCounts({
            error: Error()
          }), SharedBtnCounts) : SharedBtnCounts).claim();
          if (!granted) return;
          const startNode = ((_this$okButton2 = this.okButton) == null ? void 0 : _this$okButton2.node) || this.node;
          const pv = (_find = find('Canvas/pet_value')) == null ? void 0 : _find.getComponent(_crd && PetValue === void 0 ? (_reportPossibleCrUseOfPetValue({
            error: Error()
          }), PetValue) : PetValue);
          const btn1 = find('Canvas/btn/Button1');
          const btn2 = find('Canvas/btn/Button2');
          const btn3 = find('Canvas/btn/Button3');
          const btn1Label = btn1 == null ? void 0 : btn1.getComponentInChildren(Label);
          const btn2Label = btn2 == null ? void 0 : btn2.getComponentInChildren(Label);
          const btn3Label = btn3 == null ? void 0 : btn3.getComponentInChildren(Label);
