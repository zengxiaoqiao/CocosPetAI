    ...
    execute: function () {
      ...
      _export("TogglePet", TogglePet = (_dec = ccclass('TogglePet'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property({
        ...
        _applyButton2Sprite() {
          ...
          const sprite = (_this$button2Node$get = this.button2Node.getComponent(Sprite)) != null ? _this$button2Node$get : (_this$button2Node$get2 = this.button2Node.getChildByName('Sprite')) == null ? void 0 : _this$button2Node$get2.getComponent(Sprite);
        ...
        _syncPickerLayout() {
          ...
          const showCat = (_crd && isCatUnlocked === void 0 ? (_reportPossibleCrUseOfisCatUnlocked({
            error: Error()
          }), isCatUnlocked) : isCatUnlocked)();
          const showCustom = (_crd && hasCustomPet === void 0 ? (_reportPossibleCrUseOfhasCustomPet({
            error: Error()
