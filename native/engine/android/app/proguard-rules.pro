...
# SparkChain SDK uses JNI/reflection to call Java methods during auth/device-id init.
# Keep the SDK classes unchanged; otherwise libSparkChain.so can abort in GetStaticMethodID.
-keep class com.iflytek.** { *; }
-keepclassmembers class com.iflytek.** { *; }
-keepclasseswithmembernames class com.iflytek.** {
    native <methods>;
}
-dontwarn com.iflytek.**
-keep class com.iflytek.sparkchain.** { *; }
-keepclassmembers class com.iflytek.sparkchain.** { *; }
